...
public:
	...
	void AddKeyValue_JSON(JsonPair keyvalue);

	void AddKeyValue_JSON(const char* key, long value);

	void AddKeyValue_JSON(const char* key, bool value);

	void AddKeyValue_JSON(char* key, long value);
	
	void AddKeyValue_JSON(const char* key, float value);
		
	void AddKeyValue_JSON(char* key, float value);
...
void BJ_ProtocolHandler<ARRAY_LEN>::Internal_Send_JSON() {
	...
	if (!PROTOCOL_NO_WAIT_JSON_AKNOWLEDGE) {
...
template <uint8_t ARRAY_LEN>
void BJ_ProtocolHandler<ARRAY_LEN>::AddKeyValue_JSON(const char* key, float value) {
	jsonOutput[key] = value;
}

template <uint8_t ARRAY_LEN>
void BJ_ProtocolHandler<ARRAY_LEN>::AddKeyValue_JSON(char* key, float value) {
	jsonOutput[key] = value;
}
	
template <uint8_t ARRAY_LEN>
void BJ_ProtocolHandler<ARRAY_LEN>::AddKeyValue_JSON(JsonPair keyvalue) {
	jsonOutput[keyvalue.key().c_str()] = keyvalue.value();
}

template <uint8_t ARRAY_LEN>
void BJ_ProtocolHandler<ARRAY_LEN>::AddKeyValue_JSON(const char* key, bool value) {
	jsonOutput[key] = value;
}

template <uint8_t ARRAY_LEN>
void BJ_ProtocolHandler<ARRAY_LEN>::AddKeyValue_JSON(const char* key, long value) {
	jsonOutput[key] = value;
}

template <uint8_t ARRAY_LEN>
void BJ_ProtocolHandler<ARRAY_LEN>::AddKeyValue_JSON(char* key, long value) {
	jsonOutput[key] = value;
}
